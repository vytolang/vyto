/* volt/util/date native backing — calendar math via <time.h>.

   The Volt side and C agree on a flat POD `VDate` (nine ints, exact layout);
   struct tm never crosses the FFI boundary. The Volt `DateTime` is filled by
