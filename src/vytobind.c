/* vytobind — generate Vyto extern bindings from a C header.
 *
 *   vytobind <header.h> [--lib name]... [--filter prefix*]... [-I dir]... [--cc cc]
 *
 ...
 * to Vyto's FFI surface, and print a .vt module on stdout.
 *
...
int main(int argc, char **argv) {
    ...
    if (!header)
        fatal("usage: vytobind <header.h> [--lib name] [--filter prefix*] [-I dir] [--cc cc]");
    ...
    /* select functions */
    printf("// Generated by vytobind from %s — do not edit.\n", header);
    printf("// vytobind");
